...
import { CREATE_CLIENT_URI, DELETE_CLIENT_URI, GET_CLIENT_URI_BY_ID, SEARCH_CLIENT_URI, SET_CLIENT_URI_CURRENT_RECORD } from "../actions";
...
function* entityWatcher() {
  ...
  yield takeEvery(SET_CLIENT_URI_CURRENT_RECORD, setCurrentClient);
}
