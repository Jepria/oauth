...
import { clientUriReducer, initialState as clientUriInitialState } from '../../client/client-uri/state/reducer';
import { keyReducer, initialState as keyInitialState } from '../../key/state/reducer';
import { sessionReducer, initialState as sessionInitialState } from '../../session/state/reducer';
