...
public class AuthorizationRecordDefinition implements RecordDefinition {
...

  {
    ...
    fieldNames.add(AuthorizationFieldNames.CLIENT_CODE);
  ...
  private final Map<String, Class<?>> fieldTypes;
  {
    ...
    fieldTypes.put(AuthorizationFieldNames.CLIENT_CODE, String.class);
